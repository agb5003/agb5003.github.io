...
% Initiate neural network with 300 units in 1 intermediate layer
nn = nnsetup([784 300 10]); % Clears prior networks and sets up a new one
opts.numepochs = 1;
opts.batchsize = 100;
...
title("1 intermediate layer of 300 units")
